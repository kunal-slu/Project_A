...
def scd2_merge_customers(
    spark: SparkSession, new_customers: DataFrame, existing_customers_path: str
) -> DataFrame:
    """
    ...
    new_customers_with_scd2 = (
        new_customers.withColumn("start_ts", current_timestamp())
    ...
    if existing_customers.count() > 0:
        ...
        updated_customers = (
            existing_customers.alias("existing")
            .join(
