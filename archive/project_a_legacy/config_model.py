...
class IO(BaseModel):
    ...
    compression: str | None = Field(default=None, description="Compression type")
...
class PathSet(BaseModel):
    ...
    products: str | None = Field(default=None, description="Products table path")
...
class Paths(BaseModel):
    ...
    gold: PathSet | None = Field(default=None, description="Gold layer paths")
