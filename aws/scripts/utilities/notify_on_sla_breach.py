...
class SLAChecker:
    ...
    def check_sla_breach(self, job_name: str) -> Optional[Dict[str, Any]]:
        """
        ...
        if runtime_minutes > max_runtime_minutes:
            breaches.append(f"Runtime {runtime_minutes:.1f} min exceeds SLA {max_runtime_minutes} min")
                ...
                "blocks": [
                    {
                        ...
                        "text": {
                            "type": "plain_text",
                            "text": f"SLA Breach: {alert['job_name']}"
                        }
                    },
                    {
                        "type": "section",
