...
def register_delta_table(
    spark, database_name: str, table_name: str, s3_location: str, table_type: str = "DELTA"
) -> None:
    """
...
def scan_and_register_tables(spark, lake_root: str, database_name: str, layer: str) -> list[str]:
    """
