#!/bin/bash
# AWS EMR Serverless job submission script with Delta Lake configuration
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --emr6_8_compat   Add EMR 6.8 compatible packages"
            echo ""
            exit 0
            ;;
        *)
...
# Add packages based on EMR 6.8 compatibility
if [[ "$EMR6_8_COMPAT" == "true" ]]; then
