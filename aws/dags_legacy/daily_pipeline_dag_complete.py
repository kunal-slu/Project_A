...
def register_all_glue_tables(**context):
    ...
    tables_to_register = [
        {
            "database": "pyspark-etl-project_bronze_dev",
            "table": "snowflake_orders",
            "path": "s3://my-etl-lake-demo-424570854632/bronze/snowflake/orders/",
        },
        {
            "database": "pyspark-etl-project_bronze_dev",
            "table": "snowflake_customers",
            "path": "s3://my-etl-lake-demo-424570854632/bronze/snowflake/customers/",
        },
        {
            "database": "pyspark-etl-project_silver_dev",
            "table": "orders",
            "path": "s3://my-etl-lake-demo-424570854632/silver/orders/",
        },
        {
            "database": "pyspark-etl-project_silver_dev",
            "table": "customers",
            "path": "s3://my-etl-lake-demo-424570854632/silver/customers/",
        },
        {
            "database": "pyspark-etl-project_gold_dev",
            "table": "fact_sales",
            "path": "s3://my-etl-lake-demo-424570854632/gold/fact_sales/",
        },
        {
            "database": "pyspark-etl-project_gold_dev",
            "table": "dim_customer",
            "path": "s3://my-etl-lake-demo-424570854632/gold/dim_customer/",
        },
    ]
            ...
            try:
                ...
                glue.create_table(
                    ...
                    TableInput={
                        ...
                        "Parameters": {"classification": "delta", "typeOfData": "file"},
                    },
                )
...
with DAG(
            ...
            job_driver={
                "sparkSubmit": {
                    ...
                    "entryPointArguments": [
                        ...
                        "fx_json_to_bronze",
                        "--env",
                        "{{ var.value.project_a_env | default('dev') }}",
                        "--config",
                        "s3://{{ var.value.artifacts_bucket }}/config/dev.yaml",
                    ],
                    "sparkSubmitParameters": " ".join(
                        [
                            ...
                            "--py-files",
                            "s3://{{ var.value.artifacts_bucket }}/packages/dependencies.zip",
                            "--conf",
    ...
    register_glue = PythonOperator(
        task_id="register_glue_tables", python_callable=register_all_glue_tables
    )
    ...
    (
        ...
        >> bronze_to_silver
        >> dq_gate_silver
        >> [silver_to_gold_scd2, silver_to_gold_star]
        >> register_glue
        >> publish_gold_to_snowflake
    )
