...
class CostOptimizer:
    ...
    def __init__(self, resource_monitor: ResourceMonitor, aws_analyzer: AWSCostAnalyzer = None):
    ...
    def run_cost_optimization_analysis(self, days_back: int = 30) -> dict[str, Any]:
        ...
        results["total_estimated_savings"] = sum(
            rec.get("estimated_monthly_savings", rec.get("estimated_savings", 0))
    ...
    def _save_analysis_results(self, results: dict[str, Any]):
        ...
        results_file = (
            self.resource_monitor.metrics_path
            / f"cost_analysis_{results['analysis_timestamp'][:10]}.json"
        )
    ...
    def get_optimization_dashboard_data(self) -> dict[str, Any]:
        ...
        potential_cost_reduction = (
            (estimated_savings / current_monthly_cost * 100) if current_monthly_cost > 0 else 0
        )
...
def run_cost_optimization_analysis(
    days_back: int = 30, aws_access_key_id: str = None, aws_secret_access_key: str = None
) -> dict[str, Any]:
    """Run comprehensive cost optimization analysis"""
