...
def get_last_checkpoint(spark: SparkSession, table_name: str, lake_root: str) -> str | None:
    """
...
def save_checkpoint(
    spark: SparkSession, table_name: str, lake_root: str, checkpoint_time: str
) -> None:
    """
    ...
    checkpoint_df = spark.createDataFrame([(checkpoint_time,)], ["last_checkpoint"])
...
def extract_salesforce_data(
    spark: SparkSession, table_name: str, soql_query: str, connection_string: str
) -> Any:
    """
...
def get_lead_soql(last_checkpoint: str | None) -> str:
    """
...
def get_account_soql(last_checkpoint: str | None) -> str:
    """
...
def add_metadata_columns(df: Any, source: str, table_name: str) -> Any:
    ...
    """
    return (
        df.withColumn("_source", lit(source))
