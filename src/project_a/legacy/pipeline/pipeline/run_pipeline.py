...
Examples:
  ...
  python -m project_a.pipeline.run_pipeline \\
    ...
    parser.add_argument("--config", required=True, help="Config file path (local or S3 URI)")
    parser.add_argument(
        "--run-date", required=False, help="Processing date (YYYY-MM-DD). Defaults to today."
    )
