...
from .logging_config import configure_logging, log_metric, log_pipeline_event, new_run_id
...
def main(proc_date: str, env: str, config_file: str):
    ...
    log_pipeline_event(logger, "pipeline_started", "main", run_id, env=env, proc_date=proc_date)
