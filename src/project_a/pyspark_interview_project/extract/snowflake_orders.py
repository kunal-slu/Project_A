...
from project_a.utils.watermark_utils import get_watermark, upsert_watermark, get_latest_timestamp_from_df
    ...
    **kwargs
    ...
    try:
        ...
        if config.get('environment') == 'local':
            sample_path = config.get('paths', {}).get('snowflake_orders', "data/samples/snowflake/snowflake_orders_100000.csv")
        ...
        # Emit metrics
        emit_rowcount("records_extracted", record_count, {"source": "snowflake", "table": "orders"}, config)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--since-ts", type=str, help="ISO timestamp for incremental load (e.g., 2024-01-15T00:00:00Z)")
