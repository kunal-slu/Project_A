...
def run_yaml_policy(
    df: DataFrame, policy: dict[str, Any], key_cols: list[str] = None
) -> dict[str, Any]:
    """
    ...
    """
    logger.info("Running data quality policy")
    ...
    logger.info(
        f"DQ Policy Summary: {summary['overall_status']} "
