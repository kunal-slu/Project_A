...
class LineageTracker:
    ...
    def _update_dataset_lineage(self, source_dataset: str, target_dataset: str, event_id: str):
        ...
        source_file = self.lineage_storage_path / f"dataset_{source_dataset.replace('/', '_')}_upstream.json"
        ...
        target_file = self.lineage_storage_path / f"dataset_{target_dataset.replace('/', '_')}_downstream.json"
    ...
    def get_lineage_graph(self, dataset_name: str) -> Dict[str, Any]:
        ...
        upstream_file = self.lineage_storage_path / f"dataset_{dataset_name.replace('/', '_')}_upstream.json"
        downstream_file = self.lineage_storage_path / f"dataset_{dataset_name.replace('/', '_')}_downstream.json"
