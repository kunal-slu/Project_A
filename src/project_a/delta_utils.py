...
def write_staging(df: DataFrame, path: str, partition_cols: Optional[list] = None) -> None:
...
def merge_publish(spark: SparkSession, staging_path: str, publish_path: str, 
                 key: str, additional_conditions: Optional[str] = None) -> None:
