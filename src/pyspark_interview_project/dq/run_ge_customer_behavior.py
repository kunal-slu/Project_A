...
def main():
    ...
    df = spark.read \
        .format("parquet") \
        .load(f"s3a://{bucket}/bronze/customer_behavior/")
    ...
    suite = context.add_or_update_expectation_suite("customer_behavior_suite")
    ...
    validator.expect_column_values_to_be_in_set(
        "event_name",
        ["page_view", "product_view", "signup", "email_open", "email_click",
