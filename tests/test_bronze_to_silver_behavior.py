...
def sample_bronze_behavior_data(spark):
    ...
    data = [
        ("E1", "C1", "page_view", "2025-01-01 10:00:00", "SESS-123", "https://example.com/page1", None, "desktop", "US"),
        ("E2", "C1", "CLICK", "2025-01-01 10:05:00", "SESS-123", "https://example.com/page2", "https://example.com", "mobile", "US"),
        ("E3", "C2", "page_view", "2025-01-01 11:00:00", "SESS-456", "https://example.com/page1", None, "desktop", "CA"),
        ("E1", "C1", "page_view", "2025-01-01 10:00:00", "SESS-123", "https://example.com/page1", None, "desktop", "US"),  # Duplicate
    ]
    schema = StructType([
...
def test_transform_bronze_to_silver_behavior_success(
    mock_ge_runner, mock_emit_metrics, mock_emit_complete, mock_emit_start,
    mock_spark, sample_bronze_behavior_data, mock_config, tmp_path
):
    ...
    sample_bronze_behavior_data.write \
        .format("delta") \
        .mode("overwrite") \
...
def test_transform_handles_missing_bronze_data(
    mock_emit_fail, mock_emit_complete, mock_emit_start,
    mock_spark, mock_config, tmp_path
):
...
def test_transform_with_ge_failure(
    mock_ge_runner, mock_emit_complete, mock_emit_start,
    mock_spark, sample_bronze_behavior_data, mock_config, tmp_path
):
