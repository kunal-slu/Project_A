...
def test_pipeline_imports():
    ...
    try:
        from project_a.pipeline import bronze_to_silver, silver_to_gold
...
def test_utils_imports():
    ...
    try:
        from project_a.utils import config, logging, spark
...
def test_jobs_imports():
    ...
    try:
        from project_a.jobs import kafka_orders_stream, salesforce_to_bronze, snowflake_to_bronze
