...
from project_a.extract.crm_accounts import extract_crm_accounts
from project_a.extract.crm_contacts import extract_crm_contacts
from project_a.extract.crm_opportunities import extract_crm_opportunities
